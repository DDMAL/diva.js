...
(function( $ ) {
    var DocumentViewer = function(element, options) {
        var defaults =  {
            //autoScroll: true,           // ExtJs autoscroll should ALWAYS be on.
            //documentItemId: 0,          // "itemId" is reserved by ExtJS. Contains the item id for this instance.
            itemOrientation: 0,         // Either "h" (horizontal) or "v" (vertical)
            //itemLoaded: false,          // set to true once the item has been loaded initially.
            //itemRendered: false,        // set to true when the item has been rendered initially.
            //itemCenterline: 0,          // the item centerline (horizontal or vertical)
			...
			//averageHeight: 0,			// temp, for testing out gotoPage function
            //scrollDirection: "down",    // "down", "up", "left" or "right"
            viewport: [],               // Coordinates of the moving viewport
            prevVptTop: 0,           // used to determine vert. scroll direction
            //prevVptLeft: null,          // used to determine horiz. scroll direction
