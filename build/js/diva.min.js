...
!1,y=!1,z=1E3/k.throttleFPS,I,E;k.velocity=0;k.velocityY=0;var L=function(){y=x=m=!1};b(document).mouseup(L).click(L);var p=function(){k.velocity=a(s-m,k.maxvelocity);k.velocityY=a(v-x,k.maxvelocity)},w=function(a){return b.isFunction(k.filterTarget)?!1!==k.filterTarget.call(f,a):!0},D=function(a,d){if(!I||new Date>new Date(I.getTime()+z))I=new Date,y&&(m||x)&&(E&&(b(E).blur(),E=null,h.focus()),k.decelerate=!1,k.velocity=k.velocityY=0,h[0].scrollLeft=k.scrollLeft=k.x?h[0].scrollLeft-(a-m):h[0].scrollLeft,
h[0].scrollTop=k.scrollTop=k.y?h[0].scrollTop-(d-x):h[0].scrollTop,s=m,v=x,m=a,x=d,p(),g.call(h,k,k.movingClass),"function"===typeof k.moved&&k.moved.call(h,k))};k.events={touchStart:function(a){var b;if(w(a.target)){b=a.originalEvent.touches[0];var d=b.clientX;b=b.clientY;y=!0;k.velocity=s=0;k.velocityY=v=0;m=d;x=b;a.stopPropagation()}},touchMove:function(a){var b;y&&(b=a.originalEvent.touches[0],D(b.clientX,b.clientY),a.preventDefault&&a.preventDefault())},inputDown:function(a){if(w(a.target)){var b=
a.clientX,d=a.clientY;y=!0;k.velocity=s=0;k.velocityY=v=0;m=b;x=d;E=a.target;"IMG"===a.target.nodeName&&a.preventDefault();a.stopPropagation()}},inputEnd:function(a){m&&s&&!1===k.decelerate&&(k.decelerate=!0,p(),m=s=y=!1,l(h,k));E=null;a.preventDefault&&a.preventDefault()},inputMove:function(a){y&&(D(a.clientX,a.clientY),a.preventDefault&&a.preventDefault())},scroll:function(a){"function"===typeof k.moved&&k.moved.call(h,k);a.preventDefault&&a.preventDefault()},inputClick:function(a){if(0<Math.abs(k.velocity))return a.preventDefault(),
!1},dragStart:function(a){if(E)return!1}};t(h,k);h.data("kinetic-settings",k).css("cursor",k.cursor);k.triggerHardware&&h.css({"-webkit-transform":"translate3d(0,0,0)","-webkit-perspective":"1000","-webkit-backface-visibility":"hidden"})}})};b.kinetic={settingsKey:"kinetic-settings",callMethods:{start:function(a,d){var e=b(this);if(a=b.extend(a,d))a.decelerate=!1,l(e,a)},end:function(a,d){b(this);a&&(a.decelerate=!0)},stop:function(a,d){var e=b(this);h(e,a)},detach:function(a,d){var e=b(this);b.support.touch?
...
a.viewportMargin,f=e+a.panelHeight+2*a.viewportMargin;return c>=e&&c<=f||c<=e&&d>=f||d>=e&&d<=f},q=function(c){return 0<=c&&c<a.numPages},n=function(c){var b=a.pageTopOffsets[c],d=b+l(c,"h")+a.verticalPadding,e=a.pageLeftOffsets[c];c=e+l(c,"w")+a.horizontalPadding;return s(b,d)&&t(e,c)},r=function(c){return!!document.getElementById(a.ID+"page-"+c)},k=function(c){if(!r(c)||!a.allTilesLoaded[c]){var b=a.pages[c].f,d=l(c,"w"),e=l(c,"h"),f=a.pageTopOffsets[c]+a.verticalPadding,p=a.pageLeftOffsets[c]+
a.horizontalPadding,T=a.selector+"page-"+c,w;if(!r(c)){var F=document.getElementById(a.ID+"inner"),k=document.createElement("div");k.id=a.ID+"page-"+c;k.classList.add("diva-document-page");k.setAttribute("data-index",c);k.setAttribute("data-filename",b);a.enableImageTitles&&(k.title="Page "+(c+1));k.innerHTML=a.pageTools;k.style.width=d+"px";k.style.height=e+"px";a.verticallyOriented?(k.style.top=f+"px",k.classList.add("diva-page-vertical")):(k.style.left=p+"px",k.classList.add("diva-page-horizontal"));
F.appendChild(k);h(a.onPageLoad,c,b,T);diva.Events.publish("PageWillLoad",[c,b,T],g);for(w in a.plugins)h(a.plugins[w].onPageLoad,c,b,T)}a.pageTimeouts.push(setTimeout(function(c){var f=document.getElementById(a.ID+"page-"+c);if(r(c)){var p=a.imageDir+"/",k=l(c,"r"),w=l(c,"c"),F=!0,m=0,pa=e-(k-1)*a.tileHeight,D=d-(w-1)*a.tileWidth,u,q,W,da,ea,J;baseImageURL=a.iipServerURL+"?FIF="+p+b+"&JTL="+(a.zoomLevel+a.pages[c].m-a.realMaxZoom)+",";for(p=0;p<k;){u=0;for(q=p===k-1?pa:a.tileHeight;u<w;){da=p*a.tileHeight;
ea=u*a.tileWidth;W=u===w-1?D:a.tileWidth;J=baseImageURL+m;if(!document.getElementById(a.ID+"tile-"+c+"-"+m)){var n=void 0,H=void 0;a.verticallyOriented?(n=a.pageTopOffsets[c]+p*a.tileHeight+a.verticalPadding,H=a.pageLeftOffsets[c]+u*a.tileWidth):(n=a.pageTopOffsets[c]+p*a.tileHeight,H=a.pageLeftOffsets[c]+u*a.tileWidth+a.horizontalPadding);var qa=H+a.tileWidth;s(n,n+a.tileHeight)&&t(H,qa)?(n=document.createElement("div"),n.id=a.ID+"tile-"+c+"-"+m,n.classList.add("diva-document-tile"),n.style.display=
"inline",n.style.position="absolute",n.style.top=da+"px",n.style.left=ea+"px",n.style.backgroundImage="url('"+J+"')",n.style.height=q+"px",n.style.width=W+"px",f.appendChild(n)):F=!1}m++;u++}p++}a.allTilesLoaded[c]=F;h(a.onPageLoaded,c,b,T);diva.Events.publish("PageDidLoad",[c,b,T],g)}},a.pageLoadTimeout,c))}},S=function(c){c=document.getElementById(a.ID+"page-"+c);if(null!==c){for(;c.firstChild;)c.removeChild(c.firstChild);c.parentNode.removeChild(c)}},K=function(c){if(a.verticallyOriented){c=a.pageTopOffsets[c]+
l(c,"h")+a.verticalPadding;var b=document.getElementById(a.ID+"outer").scrollTop}else c=a.pageLeftOffsets[c]+l(c,"w")+a.horizontalPadding,b=document.getElementById(a.ID+"outer").scrollLeft;return c=c<b},x=function(c){if(a.verticallyOriented){c=a.pageTopOffsets[c];var b=document.getElementById(a.ID+"outer").scrollTop+a.panelHeight}else c=a.pageLeftOffsets[c],b=document.getElementById(a.ID+"outer").scrollLeft+a.panelWidth;return c=c>b},v=function(c,b){0<b?q(c)&&(n(c)?(k(c),a.lastPageLoaded=c,v(a.lastPageLoaded+
1,b)):K(c)&&v(c+1,b)):q(c)&&(n(c)?(k(c),a.firstPageLoaded=c,v(a.firstPageLoaded-1,b)):x(c)&&v(c-1,b))},y=function(c,b){0<b?q(c)&&K(c)&&(S(c),a.firstPageLoaded=c+1,y(a.firstPageLoaded,b)):q(c)&&x(c)&&(S(c),a.lastPageLoaded=c-1,y(a.lastPageLoaded,b))},z=function(c){return 0<=c&&c<a.numRows},I=function(c){c*=a.rowHeight;return s(c,c+a.rowHeight+a.fixedPadding)},E=function(c){if(!document.getElementById(a.ID+"row-"+c)){var b=a.rowHeight*c+a.fixedPadding,d=document.getElementById(a.ID+"inner"),e=document.createElement("div");
e.id=a.ID+"row-"+c;e.classList.add("diva-row");e.style.height=a.rowHeight+"px";e.style.top=b+"px";d.appendChild(e);for(var f,p,h,k,w,F,m=a.imageDir+"/",D=a.pagesPerRow,d=0;d<D;d++){f=c*a.pagesPerRow+d;if(!q(f))break;p=a.pages[f].f;h=l(f,"w");k=l(f,"h");w=a.fixedHeightGrid?(a.rowHeight-a.fixedPadding)*h/k:a.gridPageWidth;h=a.fixedHeightGrid?a.rowHeight-a.fixedPadding:w/h*k;k=parseInt(d*(a.fixedPadding+a.gridPageWidth)+a.fixedPadding,10);w=parseInt(w,10);h=parseInt(h,10);k+=a.fixedHeightGrid?(a.gridPageWidth-
w)/2:0;F=encodeURI(a.iipServerURL+"?FIF="+m+p+"&HEI="+(h+2)+"&CVT=JPEG");a.pageTopOffsets[f]=b;a.pageLeftOffsets[f]=k;var u=document.createElement("div");u.id=a.ID+"page-"+f;var n=a.selector+"page-"+f;u.classList.add("diva-page");u.style.width=w+"px";u.style.height=h+"px";u.style.left=k+"px";u.setAttribute("data-index",f);u.setAttribute("data-filename",p);a.enableImageTitles&&(u.title="Page "+(f+1));e.appendChild(u);diva.Events.publish("PageWillLoad",[f,p,n],g);W(c,f,F,w,h)}}},L=function(c){c=document.getElementById(a.ID+
"row-"+c);if(null!==c){for(;c.firstChild;)c.removeChild(c.firstChild);c.parentNode.removeChild(c)}},p=function(c){c=a.rowHeight*(c+1);var b=document.getElementById(a.ID+"outer").scrollTop;return c<b},w=function(c){c*=a.rowHeight;var b=document.getElementById(a.ID+"outer").scrollTop+a.panelHeight;return c>b},D=function(c,b){0<b?z(c)&&(I(c)?(E(c),a.lastRowLoaded=c,D(a.lastRowLoaded+1,b)):p(c)&&D(c+1,b)):z(c)&&(I(c)?(E(c),a.firstRowLoaded=c,D(a.firstRowLoaded-1,b)):w(c)&&D(c-1,b))},F=function(c,b){0<
b?z(c)&&p(c)&&(L(c),a.firstRowLoaded++,F(a.firstRowLoaded,b)):z(c)&&w(c)&&(L(c),a.lastRowLoaded--,F(a.lastRowLoaded,b))},W=function(c,b,d,e,f){a.pageTimeouts.push(window.setTimeout(function(c,b,d,e,f){document.getElementById(a.ID+"row-"+c)&&(c=document.createElement("img"),c.src=d,c.style.width=e+"px",c.style.height=f+"px",document.getElementById(a.ID+"page-"+b).appendChild(c))},a.rowLoadTimeout,c,b,d,e,f))},J=function(c){var b=a.currentPageIndex,d=b+c;if(!q(d))return!1;var e=a.verticallyOriented?
document.getElementById(a.ID+"outer").scrollTop+a.panelHeight/2:document.getElementById(a.ID+"outer").scrollLeft+a.panelWidth/2,f=!1;0>c?a.verticallyOriented?0<=d&&a.pageTopOffsets[d]+l(d,"h")+a.verticalPadding>=e&&(f=!0):0<=d&&a.pageLeftOffsets[d]+l(d,"w")+a.horizontalPadding>=e&&(f=!0):0<c&&(a.verticallyOriented?a.pageTopOffsets[b]+l(b,"h")+a.verticalPadding<e&&(f=!0):a.pageLeftOffsets[b]+l(b,"w")+a.horizontalPadding<e&&(f=!0));return f?(a.currentPageIndex=d,0===c||J(c)||(c=a.pages[d].f,h(a.onSetCurrentPage,
d,c),diva.Events.publish("VisiblePageDidChange",[d,c],g)),!0):!1},N=function(c){var b=Math.floor(a.currentPageIndex/a.pagesPerRow),d=b+parseInt(c,10),e=document.getElementById(a.ID+"outer").scrollTop,f=e+a.panelHeight/2,p=!1;0>c?0<=d&&(a.rowHeight*b>=f||a.rowHeight*d>=e)&&(p=!0):0<c&&a.rowHeight*(b+1)<e&&z(d)&&(p=!0);return p?(a.currentPageIndex=d*a.pagesPerRow,0===c||N(c)||(c=a.currentPageIndex,diva.Events.publish("VisiblePageDidChange",[c,a.pages[c].f],g)),!0):!1},G=function(c,b,d){d="undefined"!==
typeof d?d:0;b=a.pageTopOffsets[c]+("undefined"!==typeof b?b:0)-parseInt(a.panelHeight/2,10);d=a.pageLeftOffsets[c]+d-parseInt(a.panelWidth/2,10);a.outerObject.scrollTop(b);a.outerObject.scrollLeft(d);c!==a.currentPageIndex&&(a.currentPageIndex=c,d=a.pages[c].f,h(a.onSetCurrentPage,c,d),diva.Events.publish("VisiblePageDidChange",[c,d],g));h(a.onJump,c);diva.Events.publish("ViewerDidJump",[c],g)},u=function(c){a.outerObject.scrollTop(Math.floor(c/a.pagesPerRow)*a.rowHeight);a.currentPageIndex=c;diva.Events.publish("VisiblePageDidChange",
[c,a.pages[c].f],g)},H=function(c){return c>=a.minZoomLevel&&c<=a.maxZoomLevel?c:a.minZoomLevel},fa=function(c){return c>=a.minPagesPerRow&&c<=a.maxPagesPerRow?c:a.maxPagesPerRow},ga=function(){a.allTilesLoaded=[];a.outerObject.scrollTop(0);a.innerObject.empty();a.firstPageLoaded=0;a.firstRowLoaded=-1;a.previousTopScroll=0;a.previousLeftScroll=0;for(clearTimeout(a.resizeTimer);a.pageTimeouts.length;)clearTimeout(a.pageTimeouts.pop())},O=function(){a.inGrid?ha():Y()},Y=function(){ga();a.zoomLevel=
H(a.zoomLevel);var c=a.zoomLevel;a.totalHeight=a.totalHeights[c]+a.verticalPadding*(a.numPages+1);a.totalWidth=a.totalWidths[c]+a.horizontalPadding*(a.numPages+1);var b=a.maxHeights[c]+2*a.verticalPadding,d=Math.max(a.maxWidths[c]+2*a.horizontalPadding,a.panelWidth),b=Math.max(b,a.panelHeight),e=document.getElementById(a.ID+"inner");a.verticallyOriented?(e.style.height=Math.round(a.totalHeight)+"px",e.style.width=Math.round(d)+"px"):(e.style.height=Math.round(b)+"px",e.style.width=Math.round(a.totalWidth)+
"px");var f=0,p=0;a.pageTopOffsets=[];a.pageLeftOffsets=[];for(e=0;e<a.numPages;e++)a.pageTopOffsets[e]=parseInt(a.verticallyOriented?f:(b-l(e,"h"))/2,10),a.pageLeftOffsets[e]=parseInt(a.verticallyOriented?(d-l(e,"w"))/2:p,10),f=a.pageTopOffsets[e]+l(e,"h")+a.verticalPadding,p=a.pageLeftOffsets[e]+l(e,"w")+a.horizontalPadding;q(a.goDirectlyTo)||(a.goDirectlyTo=0);G(a.goDirectlyTo,a.verticalOffset,a.horizontalOffset);d=!1;for(e=0;e<a.numPages;e++)if(n(e))k(e),a.lastPageLoaded=e,d=!0;else if(d)break;
0<=a.oldZoomLevel?(a.oldZoomLevel<a.zoomLevel?(h(a.onZoomIn,c),diva.Events.publish("ViewerDidZoomIn",[c],g)):(h(a.onZoomOut,c),diva.Events.publish("ViewerDidZoomOut",[c],g)),h(a.onZoom,c)):a.oldZoomLevel=a.zoomLevel;a.scaleWait&&(a.scaleWait=!1);c=a.pages[a.currentPageIndex].f;h(a.onDocumentLoaded,a.currentPageIndex,c);diva.Events.publish("DocumentDidLoad",[a.currentPageIndex,c],g)},ha=function(){var c=a.currentPageIndex;a.verticalOffset=a.verticallyOriented?a.panelHeight/2:l(c,"h")/2;a.horizontalOffset=
a.verticallyOriented?l(c,"w")/2:a.panelWidth/2;ga();a.pagesPerRow=fa(a.pagesPerRow);c=(a.panelWidth-a.fixedPadding*(a.pagesPerRow+1))/a.pagesPerRow;a.gridPageWidth=c;a.rowHeight=a.fixedHeightGrid?a.fixedPadding+a.minRatio*c:a.fixedPadding+a.maxRatio*c;a.numRows=Math.ceil(a.numPages/a.pagesPerRow);a.totalHeight=a.numRows*a.rowHeight+a.fixedPadding;c=document.getElementById(a.ID+"inner");c.style.height=Math.round(a.totalHeight)+"px";c.style.width=Math.round(a.panelWidth)+"px";u(a.goDirectlyTo);var b;
a.pageTopOffsets=[];a.pageLeftOffsets=[];for(var d=a.numPages,c=0;c<d;c+=a.pagesPerRow)b=Math.floor(c/a.pagesPerRow),I(b)&&(a.firstRowLoaded=0>a.firstRowLoaded?b:a.firstRowLoaded,E(b),a.lastRowLoaded=b)},ia=function(a){27==a.keyCode&&A()},Z=function(c){a.outerObject.toggleClass("diva-fullscreen");b("body").toggleClass("diva-hide-scrollbar");a.parentObject.toggleClass("diva-full-width");if(a.mobileWebkit){var d=parseInt(a.outerObject.css("margin-left"),10)-parseInt(b("body").css("margin-left"),10);
a.outerObject.css("margin-left",d)}var d=a.panelHeight,e=a.panelWidth;P();if(0<=a.oldZoomLevel&&!a.inGrid){var f=a.panelHeight,p=a.panelWidth;a.inFullscreen?(a.verticalOffset-=(f-d)/2,a.horizontalOffset-=(p-e)/2):(a.verticalOffset+=(d-f)/2,a.horizontalOffset+=(e-p)/2)}c?(a.inGrid=!a.inGrid,B()):O();if(a.inFullscreen)b(document).on("keyup",ia);else b(document).off("keyup",ia);h(a.onModeToggle,a.inFullscreen);diva.Events.publish("ModeDidSwitch",[a.inFullscreen],g)},B=function(){O();h(a.onViewToggle,
a.inGrid);diva.Events.publish("ViewDidSwitch",[a.inGrid],g)},A=function(){a.goDirectlyTo=a.currentPageIndex;a.inFullscreen=!a.inFullscreen;Z(!1)},C=function(){a.goDirectlyTo=a.currentPageIndex;a.inGrid=!a.inGrid;B()},aa=function(c){var d=b(this).offset();a.doubleClickZoom=!0;a.horizontalOffset=c.pageX-d.left;a.verticalOffset=c.pageY-d.top;a.goDirectlyTo=parseInt(b(this).attr("data-index"),10);M(c.ctrlKey?a.zoomLevel-1:a.zoomLevel+1)},ja=function(c){var d=parseInt(b(this).attr("data-index"),10);a.goDirectlyTo=
...
fa(c);if(b!==c)return!1;a.pagesPerRow=b;diva.Events.publish("GridRowNumberDidChange",[b],g);a.goDirectlyTo=a.currentPageIndex;ha();return!0},Q=function(c,b){c="undefined"===typeof c?a.currentPageIndex:c;return"center"===b||"centre"===b?parseInt(l(c,"h")/2,10):"bottom"===b?parseInt(l(c,"h")-a.panelHeight/2,10):parseInt(a.panelHeight/2,10)},R=function(c,b){c="undefined"===typeof c?a.currentPageIndex:c;return"left"===b?parseInt(a.panelWidth/2,10):"right"===b?parseInt(l(c,"w")-a.panelWidth/2,10):parseInt(l(c,
"w")/2,10)},U=function(){return document.getElementById(a.ID+"outer").scrollTop-a.pageTopOffsets[a.currentPageIndex]+parseInt(a.panelHeight/2,10)},V=function(){return document.getElementById(a.ID+"outer").scrollLeft-a.pageLeftOffsets[a.currentPageIndex]+parseInt(a.panelWidth/2,10)},ka=function(){return{f:a.inFullscreen,g:a.inGrid,z:a.zoomLevel,n:a.pagesPerRow,i:a.enableFilename?a.pages[a.currentPageIndex].f:!1,p:a.enableFilename?!1:a.currentPageIndex+1,y:a.inGrid?!1:U(),x:a.inGrid?!1:V()}},la=function(){var c=
ka(),b=[],d;for(d in c)!1!==c[d]&&b.push(d+a.hashParamSuffix+"="+c[d]);return b.join("&")},ma=function(){return location.protocol+"//"+location.host+location.pathname+"#"+la()},P=function(){var c=document.getElementById(a.ID+"outer");a.panelHeight=c.clientHeight-(c.scrollWidth>c.clientWidth?a.scrollbarWidth:0);a.panelWidth=c.clientWidth-(c.scrollHeight>c.clientHeight?a.scrollbarWidth:0);a.horizontalOffset=V();a.verticalOffset=U();G(a.currentPageIndex,a.verticalOffset,a.horizontalOffset);return!0},
na=function(){a.mobileWebkit||(a.outerObject.dragscrollable({dragSelector:".diva-dragger",acceptPropagatedEvent:!0}),a.innerObject.dragscrollable({dragSelector:".diva-dragger",acceptPropagatedEvent:!0}));a.outerObject.on("dblclick",".diva-document-page",function(a){aa.call(this,a)});a.outerObject.on("contextmenu",".diva-document-page",function(c){if(c.ctrlKey)return clearTimeout(a.singleClickTimeout),a.singleClick?(aa.call(this,c),a.singleClick=!1):(a.singleClick=!0,a.singleClickTimeout=setTimeout(function(){a.singleClick=
!1},500)),!1});a.outerObject.on("dblclick",".diva-row",function(a){ja.call(b(a.target).parent(),a)})},ba=function(a,b,d,e){return Math.sqrt((a-b)*(a-b)+(d-e)*(d-e))},ra=function(){a.innerObject.mouseover(function(){b(this).removeClass("diva-grabbing").addClass("diva-grab")});a.innerObject.mouseout(function(){b(this).removeClass("diva-grab")});a.innerObject.mousedown(function(){b(this).removeClass("diva-grab").addClass("diva-grabbing")});a.innerObject.mouseup(function(){b(this).removeClass("diva-grabbing").addClass("diva-grab")});
na();a.outerObject.scroll(function(){var c,b=document.getElementById(a.ID+"outer").scrollTop,d=document.getElementById(a.ID+"outer").scrollLeft;c=a.verticallyOriented||a.inGrid?b-a.previousTopScroll:d-a.previousLeftScroll;if(a.inGrid){0>c?(D(a.firstRowLoaded,-1),N(-1),F(a.lastRowLoaded,-1)):0<c&&(D(a.lastRowLoaded,1),N(1),F(a.firstRowLoaded,1));var e=document.getElementById(a.ID+"outer").scrollTop}else{if(0>c)v(a.firstPageLoaded,c),J(-1),y(a.lastPageLoaded,c);else if(0<c)v(a.lastPageLoaded,c),J(1),
y(a.firstPageLoaded,c);else for(var f=a.lastPageLoaded,e=Math.max(a.firstPageLoaded,0);e<=f;e++)n(e)&&k(e);e=a.verticallyOriented?document.getElementById(a.ID+"outer").scrollTop:document.getElementById(a.ID+"outer").scrollLeft}h(a.onScroll,e);diva.Events.publish("ViewerDidScroll",[e],g);0<c?(h(a.onScrollDown,e),diva.Events.publish("ViewerDidScrollDown",[e],g)):0>c&&(h(a.onScrollUp,e),diva.Events.publish("ViewerDidScrollUp",[e],g));a.previousTopScroll=b;a.previousLeftScroll=d;a.horizontalOffset=V();
...
a.currentPageIndex,a.inGrid)a.inGrid=!1,B();else a:{var g=a.zoomLevel;if(100<d&&g<a.maxZoomLevel)g++;else if(-100>d&&g>a.minZoomLevel)g--;else break a;a.scaleWait=!0;d=b(this).offset();a.horizontalOffset=c.pageX-d.left;a.verticalOffset=c.pageY-d.top;a.goDirectlyTo=parseInt(b(this).attr("data-index"),10);M(g)}}});var p={},w=0,c=function(c){if(a.singleTap){var d={pageX:c.originalEvent.changedTouches[0].clientX,pageY:c.originalEvent.changedTouches[0].clientY};w=ba(p.pageX,d.pageX,p.pageY,d.pageY);50>
w&&a.zoomLevel<a.maxZoomLevel&&(a.inGrid?ja.call(b(c.target).parent(),d):aa.call(this,d));a.singleTap=!1;p={}}else a.singleTap=!0,p.pageX=c.originalEvent.changedTouches[0].clientX,p.pageY=c.originalEvent.changedTouches[0].clientY,a.singleTapTimeout=setTimeout(function(){a.singleTap=!1;p={}},250)};a.outerObject.on("touchend",".diva-document-page",c);a.outerObject.on("touchend",".diva-page",c);c="onorientationchange"in window?"orientationchange":"resize";b(window).bind(c,function(c){c=a.panelWidth;
...
"pages-per-row").textContent=a.pagesPerRow},closePopups:function(){b(".diva-popup").css("display","none")},switchView:function(){b(a.selector+c+"-slider").hide();b(a.selector+c+"-out-button").hide();b(a.selector+c+"-in-button").hide();b(a.selector+c+"-slider-label").hide();b(a.selector+c+"-buttons-label").hide();c=a.inGrid?"grid":"zoom";b(a.selector+c+"-slider").show();b(a.selector+c+"-out-button").show();b(a.selector+c+"-in-button").show();b(a.selector+c+"-slider-label").show();b(a.selector+c+"-buttons-label").show();
b(a.selector+"grid-icon").toggleClass("diva-in-grid")},switchMode:function(){b(a.selector+"tools").toggleClass("diva-fullscreen-tools");a.inFullscreen?b(a.selector+"tools-left").addClass("in-fullscreen"):b(a.selector+"tools-left").removeClass("in-fullscreen")}}},ta=function(){if(window.divaPlugins){var c=[];b.each(window.divaPlugins,function(b,d){var e=d.pluginName[0].toUpperCase()+d.pluginName.substring(1);a["enable"+e]&&d.init(a,g)&&(e=d.titleText||e+" plugin","function"===typeof d.handleClick&&
(c.push('<div class="diva-'+d.pluginName+'-icon" title="'+e+'"></div>'),a.outerObject.on(a.mobileWebkit?"touchend":"click",".diva-"+d.pluginName+"-icon",function(c){d.handleClick.call(this,c,a,g)})),a.plugins.push(d))});c.length&&(a.pageTools='<div class="diva-page-tools">'+c.join("")+"</div>")}},oa=function(){clearTimeout(a.throbberTimeoutID);b(a.selector+"throbber").hide()},ua=function(){a.outerObject.append('<div id="'+a.ID+'throbber" class="diva-throbber"></div>');a.throbberTimeoutID=setTimeout(function(){b(a.selector+
"throbber").show()},a.throbberTimeout);b.ajax({url:a.objectData,cache:!0,dataType:"json",error:function(c,b,d){oa();c='<div id="'+a.ID+'error" class="diva-error"><p><strong>Error</strong></p><p>Invalid objectData. Error code: '+b+" "+d+"</p>";0===a.objectData.lastIndexOf("http",0)&&""===d&&(d=a.objectData.replace(/https?:\/\//i,"").split(/[/?#]/)[0],location.hostname!==d&&(c+='<p>Attempted to access cross-origin data without CORS.</p><p>You may need to update your server configuration to support CORS. For help, see the <a href="https://github.com/DDMAL/diva.js/wiki/Installation#a-note-about-cross-site-requests" target="_blank">cross-site request documentation.</a></p>'));
a.outerObject.append(c+"</div>")},success:function(c,d,e){oa();a.pages=c.pgs;a.maxRatio=c.dims.max_ratio;a.minRatio=c.dims.min_ratio;a.itemTitle=c.item_title;a.numPages=c.pgs.length;a.maxWidths=c.dims.max_w;a.maxHeights=c.dims.max_h;a.averageWidths=c.dims.a_wid;a.averageHeights=c.dims.a_hei;a.totalHeights=c.dims.t_hei;a.totalWidths=c.dims.t_wid;a.realMaxZoom=c.max_zoom;a.maxZoomLevel=0<=a.maxZoomLevel&&a.maxZoomLevel<=c.max_zoom?a.maxZoomLevel:c.max_zoom;a.minZoomLevel=0<=a.minZoomLevel&&a.minZoomLevel<=
...
a.toolbar.switchMode),diva.Events.subscribe("ViewDidSwitch",a.toolbar.switchView),diva.Events.subscribe("ZoomLevelDidChange",a.toolbar.updateZoomSlider),diva.Events.subscribe("ZoomLevelDidChange",a.toolbar.updateZoomButtons),diva.Events.subscribe("GridRowNumberDidChange",a.toolbar.updateGridSlider),diva.Events.subscribe("ZoomLevelDidChange",a.toolbar.updateGridButtons),diva.Events.subscribe("ClosePopups",a.toolbar.closePopups));b(a.selector+"current label").text(a.numPages);a.enableAutoTitle&&a.parentObject.prepend('<div id="'+
a.ID+'title" class="diva-title">'+a.itemTitle+"</div>");a.parentObject.parent()[0]!==document.body||a.parentObject.siblings().not("#diva-canvas-backdrop")[0]||(a.divaIsFullWindow=!0);P();q(parseInt(a.goDirectlyTo),10)||(a.goDirectlyTo=0);0<a.adaptivePadding?(c=a.zoomLevel,a.horizontalPadding=parseInt(a.averageWidths[c]*a.adaptivePadding,10),a.verticalPadding=parseInt(a.averageHeights[c]*a.adaptivePadding,10)):(a.horizontalPadding=a.fixedPadding,a.verticalPadding=a.fixedPadding);a.pageTools.length&&
...
a.pages[c].m:!1};this.getMinZoomLevel=function(){return a.minZoomLevel};this.setZoomLevel=function(c){a.inGrid&&C();return M(c)};this.zoomIn=function(){return this.setZoomLevel(a.zoomLevel+1)};this.zoomOut=function(){return this.setZoomLevel(a.zoomLevel-1)};this.inViewport=function(c,b,d,e,f){c-=1;d=a.pageTopOffsets[c]+d;b=a.pageLeftOffsets[c]+b;e=b+e;return s(d,d+f)&&t(b,e)};this.isPageInViewport=function(a){return n(a)};this.isPageInDOM=function(a){return r(a)};this.toggleFullscreenMode=function(){A()};
this.enterFullscreenMode=function(){return a.inFullscreen?!1:(A(),!0)};this.leaveFullscreenMode=function(){return a.inFullscreen?(A(),!0):!1};this.toggleGridView=function(){C()};this.enterGridView=function(){return a.inGrid?!1:(C(),!0)};this.leaveGridView=function(){return a.inGrid?(C(),!0):!1};this.gotoPageByName=function(a,b,d){a=m(a);return q(a)?(G(a,Q(a,d),R(a,b)),!0):!1};this.getPageIndex=function(a){return m(a)};this.getCurrentURL=function(){return ma()};this.getURLHash=function(){return la()};
this.getState=function(){return ka()};this.getInstanceSelector=function(){return a.selector};this.getInstanceId=function(){return a.ID};this.getSettings=function(){return a};this.translateFromMaxZoomLevel=function(c){return c/Math.pow(2,a.maxZoomLevel-a.zoomLevel)};this.translateToMaxZoomLevel=function(c){var b=a.maxZoomLevel-a.zoomLevel;return 0===b?c:c*Math.pow(2,b)};this.setState=function(c){var b;b=m(c.i);q(b)?a.goDirectlyTo=b:q(c.p)&&(a.goDirectlyTo=c.p);horizontalOffset=parseInt(c.x,10);verticalOffset=
parseInt(c.y,10);c.z>=a.minZoomLevel&&c.z<=a.maxZoomLevel&&(a.zoomLevel=c.z);c.n>=a.minPagesPerRow&&c.n<=a.maxPagesPerRow&&(a.pagesPerRow=c.n);a.inFullscreen!==c.f?(a.inFullscreen=c.f,Z(a.inGrid!==c.g),a.horizontalOffset=horizontalOffset,a.verticalOffset=verticalOffset,G(b,a.verticalOffset,a.horizontalOffset)):(a.horizontalOffset=horizontalOffset,a.verticalOffset=verticalOffset,a.inGrid!==c.g?(a.inGrid=c.g,B()):O())};this.enableScrollable=function(){a.isScrollable||(na(),a.enableKeyScroll=a.initialKeyScroll,
...
10);b(window).on("keyup",function(a){a.shiftKey&&32===a.keyCode&&f.toggleScrolling()});e.disableAutoscrollPrefs||diva.Events.subscribe("ViewerDidLoad",function(a){a="<div id='"+e.ID+"autoscroll-prefs' class='diva-autoscroll-prefs diva-popup'><b>Autoscrolling options:</b><br><span class='diva-autoscroll-prefs-text'>Pixels per second:</span><input type='range' id='"+e.ID+"autoscroll-pps' class='diva-autoscroll-pps diva-autoscroll-prefs-input' value='"+Math.log(l)/Math.log(10)+"' min='0' max='3' step='0.1'><br><span class='diva-autoscroll-prefs-text'>Allow manual scroll:</span><input type='checkbox' id='"+
...
180);e.drawImage(a,g,h,b.width,b.height);e.restore();b.data=e.getImageData(0,0,b.size,b.size)},t=function(){for(var a in g)if(g[a].current!==g[a].previous)return!0;return!1},s=function(){m(f,g.rotation.current);r(f)},q=function(){var a=g.rotation.current,f=g.zoom.current,h=g.zoom.previous;if(a!==g.rotation.previous||f!==h){var k=b("#diva-canvas-wrapper").scrollLeft(),l=b("#diva-canvas-wrapper").scrollTop(),n=d.viewport.width/2,q=d.viewport.height/2,k=k+n-e.centerX,s=-(l+q-e.centerY),u=(g.rotation.previous-
a)*Math.PI/180,l=Math.cos(u)*k-Math.sin(u)*s+e.centerX,k=-(Math.sin(u)*k+Math.cos(u)*s)+e.centerY,f=Math.pow(2,f-h),n=f*l-n,q=f*k-q;m(e,a);b("#diva-canvas-wrapper").scrollLeft(n);b("#diva-canvas-wrapper").scrollTop(q)}if(t()){r(e);for(var H in g)g[H].previous=g[H].current}},n=function(a){var b=g[a].current!==g[a].initial;return g[a].current!==g[a].previous||b},r=function(a){var b=a.data,e=a.context.createImageData(b),f=e.data,h,k;h=0;for(k=f.length;h<k;h++)f[h]=b.data[h];b=e.data;h=g.contrast.current;
f=(1+Math.min(d.brightnessMax,Math.max(d.brightnessMin,g.brightness.current))/d.brightnessMax)*h;h=128-128*h;k=g.red.current;var l=g.green.current,m=g.blue.current,u=n("red"),q=n("green"),s=n("blue"),t=n("brightness"),r=n("contrast"),t=t||r,x,y,v,z,B,A,C,r=0;for(y=e.width;r<y;r++)for(x=0,v=e.height;x<v;x++)z=4*(x*y+r),B=b[z],A=b[z+1],C=b[z+2],0<B+A+C&&(u&&B&&(B+=k),q&&A&&(A+=l),s&&C&&(C+=m),t&&(B&&(B=B*f+h),A&&(A=A*f+h),C&&(C=C*f+h)),b[z]=B,b[z+1]=A,b[z+2]=C);a.context.clearRect(0,0,y,v);a.context.putImageData(e,
...
e.canvas.width=e.size;e.canvas.height=e.size;e.cornerX=(e.size-a.width)/2;e.cornerY=(e.size-a.height)/2;e.width=a.width;e.height=a.height;e.centerX=e.size/2;e.centerY=e.size/2;e.context=e.canvas.getContext("2d");e.context.drawImage(a,e.cornerX,e.cornerY,e.width,e.height);try{e.data=e.context.getImageData(0,0,e.size,e.size)}catch(g){var p='<div id="diva-error" class="diva-error"><p><strong>Error</strong></p><p>'+g.message+"</p>";if("SecurityError"!==g.name)throw g;p+='<p>You may need to update your server configuration in order to use the image manipulation tools. For help, see the <a href="https://github.com/DDMAL/diva.js/wiki/The-API-and-Plugins#a-note-about-canvas-and-cross-site-data" target="_blank">canvas cross-site data documentation</a>.</p></div></div>';
b("#diva-canvas-backdrop").append(p);z()}void 0===h&&(p=a,f.canvas=document.getElementById("diva-canvas-minimap"),f.size=d.mapSize,f.canvas.width=f.size,f.canvas.height=f.size,f.context=f.canvas.getContext("2d"),f.context.fillRect(0,0,f.size,f.size),f.scaleFactor=d.mapSize/e.size,f.cornerX=e.cornerX*f.scaleFactor,f.cornerY=e.cornerY*f.scaleFactor,f.width=p.width*f.scaleFactor,f.height=p.height*f.scaleFactor,f.context.drawImage(p,f.cornerX,f.cornerY,f.width,f.height),f.data=f.context.getImageData(0,
...
z=function(){b(d.selector+"throbber").removeClass("canvas-throbber").hide()},I=function(){var a={},b=!1,e=d.localStoragePrefix+d.filename,f;for(f in g)g[f].previous!==g[f].initial&&(a[f]=g[f].previous,b=!0);b?(d.pluginIcon.addClass("new"),localStorage.setObject(e,a)):(d.pluginIcon.removeClass("new"),localStorage.removeItem(e))},E=function(a,b){d.zoomLevel=a;var g=v(a);S(g,function(){f.scaleFactor=f.size/e.size;k();I()})},L=function(a){switch(a.keyCode){case 38:return b("#diva-canvas-wrapper").scrollTop(document.getElementById("diva-canvas-wrapper").scrollTop-
...
"&deg;"},title:"Rotate the image"},zoom:{initial:0,min:0,max:0,step:1,title:"Adjust the zoom level"},red:{initial:0,min:d.rgbMin,max:d.rgbMax,step:1,title:"Adjust the red channel"},green:{initial:0,min:d.rgbMin,max:d.rgbMax,step:1,title:"Adjust the green channel"},blue:{initial:0,min:d.rgbMin,max:d.rgbMax,step:1,title:"Adjust the blue channel"}};var n=function(){var a,b,d;for(d in g)b=g[d],a=b.initial,b.current=a,b.previous=a};n();if(b("#diva-canvas-backdrop").length)return!0;var r=[],v,J,N;for(N in d.buttons)v=
...
0,e.size,e.size);f.context.clearRect(0,0,f.size,f.size);b("#diva-canvas-wrapper").scrollTop(0).scrollLeft(0);b("#diva-canvas-backdrop").hide();b("#diva-map-viewbox").hide();z();m.enableScrollable();b(document).off("keydown",L);n();K();x();b("#diva-canvas-buttons .clicked").removeClass("clicked");G("contrast");diva.Events.publish("CanvasViewDidHide")});b("#diva-canvas-minimise").click(function(){b("#diva-canvas-toolwindow").slideToggle("fast")});b(window).resize(function(){d.viewport={height:window.innerHeight-
...
a){h=m[d].regions[s];l=parseFloat(h.uly)+parseFloat(h.height)/2;h=parseFloat(h.ulx)+parseFloat(h.width)/2;t=!0;break}}else for(var s=Object.keys(m),q=s.length;q--;){for(var n=m[s[q]].regions,r=n.length;r--;)if(n[r].divID==a){d=s[q];h=n[r];l=parseFloat(h.uly)+parseFloat(h.height)/2;h=parseFloat(h.ulx)+parseFloat(h.width)/2;t=!0;break}if(t)break}if(!t)return console.warn("Diva just tried to find a highlight that doesn't exist."),!1;m=f.getSettings().outerObject;l=f.translateFromMaxZoomLevel(l);h=f.translateFromMaxZoomLevel(h);
