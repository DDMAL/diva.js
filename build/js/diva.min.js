...
b<=a.maxZoomLevel?b:a.minZoomLevel},ia=function(b){return b>=a.minPagesPerRow&&b<=a.maxPagesPerRow?b:a.maxPagesPerRow},ba=function(){a.allTilesLoaded=[];b(a.outerSelector).scrollTop(0);b(a.innerSelector).empty();a.firstPageLoaded=0;a.firstRowLoaded=-1;a.previousTopScroll=0;a.previousLeftScroll=0;for(clearTimeout(a.resizeTimer);a.pageTimeouts.length;)clearTimeout(a.pageTimeouts.pop())},S=function(){a.inGrid?ja():ca()},ca=function(){ba();a.zoomLevel=J(a.zoomLevel);var b=a.zoomLevel;a.totalHeight=a.totalHeights[b]+
...
pageY:d.originalEvent.changedTouches[0].clientY};s=fa(g.pageX,c.pageX,g.pageY,c.pageY);50>s&&a.zoomLevel<a.maxZoomLevel&&(a.inGrid?la.call(b(d.target).parent(),c):ea.call(this,c));a.singleTap=!1;g={}}else a.singleTap=!0,g.pageX=d.originalEvent.changedTouches[0].clientX,g.pageY=d.originalEvent.changedTouches[0].clientY,a.singleTapTimeout=setTimeout(function(){a.singleTap=!1;g={}},250)};b(a.outerSelector).on("touchend",".diva-document-page",d);b(a.outerSelector).on("touchend",".diva-page",d)}if(a.enableSpaceScroll||
...
(V(a),!0):!1};this.getCurrentPage=function(){console.warn("The call to getCurrentPage is deprecated. Use getCurrentPageIndex instead.");return a.currentPageIndex};this.getNumberOfPages=function(){return ha()?a.numPages:!1};this.getPageDimensionsAtZoomLevel=function(b,c){if(!ha())return!1;c>a.maxZoomLevel&&(c=a.maxZoomLevel);var e=a.pages[b].d[parseInt(c,10)];return{width:e.w,height:e.h}};this.getCurrentPageDimensionsAtCurrentZoomLevel=function(){return this.getPageDimensionsAtZoomLevel(a.currentPageIndex,
...
!1:(F(),!0)};this.leaveFullscreenMode=function(){return a.inFullscreen?(F(),!0):!1};this.toggleGridView=function(){B()};this.enterGridView=function(){return a.inGrid?!1:(B(),!0)};this.leaveGridView=function(){return a.inGrid?(B(),!0):!1};this.gotoPageByName=function(a){a=r(a);return u(a)?(V(a),!0):!1};this.getPageIndex=function(a){return r(a)};this.getCurrentURL=function(){return oa()};this.getURLHash=function(){return na()};this.getState=function(){return ma()};this.getInstanceSelector=function(){return a.selector};
