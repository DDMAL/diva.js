...
a.currentPageIndex;z()});b(a.outerSelector).kinetic()}if(a.enableSpaceScroll||a.enableKeyScroll){console.log("scrolley module entered");var d=b.ui.keyCode.UP,e=b.ui.keyCode.DOWN,g=b.ui.keyCode.LEFT,f=b.ui.keyCode.RIGHT,k=b.ui.keyCode.SPACE,l=b.ui.keyCode.PAGE_UP,m=b.ui.keyCode.PAGE_DOWN,x=b.ui.keyCode.HOME,y=b.ui.keyCode.END;b(document).keydown(function(c){console.log("keydown block entered");if(a.enableSpaceScroll&&c.keyCode===k||a.enableKeyScroll&&c.keyCode===m)return b(a.outerSelector).scrollTop(a.topScrollSoFar+
a.panelHeight),!1;if(a.enableKeyScroll&&c.keyCode===l)return b(a.outerSelector).scrollTop(a.topScrollSoFar-a.panelHeight),!1;if(a.enableKeyScroll&&c.keyCode===d)return b(a.outerSelector).scrollTop(a.topScrollSoFar-a.arrowScrollAmount),!1;if(a.enableKeyScroll&&c.keyCode===e)return b(a.outerSelector).scrollTop(a.topScrollSoFar+a.arrowScrollAmount),!1;if(a.enableKeyScroll&&c.keyCode===g)return b(a.outerSelector).scrollLeft(a.leftScrollSoFar-a.arrowScrollAmount),!1;if(a.enableKeyScroll&&c.keyCode===f)return b(a.outerSelector).scrollLeft(a.leftScrollSoFar+
a.arrowScrollAmount),!1;if(a.enableKeyScroll&&c.keyCode===x)return b(a.outerSelector).scrollTop(0),!1;if(a.enableKeyScroll&&c.keyCode===y)return b(a.outerSelector).scrollTop(a.totalHeight),!1});a.mobileWebkit||b(window).resize(function(){var b;a.inFullscreen?(a.panelWidth=window.innerWidth-a.scrollbarWidth,a.panelHeight=window.innerHeight,b=!0):b=U();b&&(clearTimeout(a.resizeTimer),a.resizeTimer=setTimeout(function(){a.goDirectlyTo=a.currentPageIndex;z()},200))})}},da=function(){var c='<div id="'+
a.ID+'tools-left" class="diva-tools-left">'+("slider"===a.enableZoomControls?'<div id="'+a.ID+'zoom-slider"></div>':"")+("buttons"===a.enableZoomControls?'<div id="'+a.ID+'zoom-out-button" class="diva-zoom-out-button zoom-button" title="Zoom Out"></div><div id="'+a.ID+'zoom-in-button" class="diva-zoom-in-button zoom-button" title="Zoom In"></div>':"")+("slider"===a.enableGridControls?'<div id="'+a.ID+'grid-slider"></div>':"")+("buttons"===a.enableGridControls?'<div id="'+a.ID+'grid-out-button" class="diva-grid-out-button grid-button" title="Zoom Out"></div><div id="'+
